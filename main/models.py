...
class Task(models.Model):
    ...
    assigned_to = models.ManyToManyField(Profile, related_name="tasks_assigned", blank=True)
    completed = models.BooleanField(default=False)
    completed_by = models.ManyToManyField(Profile, related_name="tasks_completed", blank=True)
